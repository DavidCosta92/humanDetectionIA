...
while True:
    ...
    #Seleccion de puntos
    pts = np.array([[[76 , 292] , [561 , 157] ,[818,239] ,[230,445]]])  # COORDENANDAS [x , y] de cada esquina de la zona de interes, desde la esq sup izquierda en sentido horario
    ...
    areag = [(76 , 292) , (561 , 157) , (818,239) , (230,445)]   # COORDENANDAS [x , y] de cada esquina de la zona de interes, desde la esq sup izquierda en sentido horario
    area3 = [(427,196) , (561 , 157) , (818,239) , (619,306)]
    area2 = [(221,251) , (427,196) , (619,306) , (382,395)]
    area1 = [(76 , 292) , (221,251) , (382,395) , (230,445)]

    #DIbujar
    #area general
    cv2.polylines(frame , [np.array(areag,np.int32)] , True , (255,255,0),5)
    #area 3
    ...
    for cont in contornos :
        ...
        if area > 1800: # segun el tamaño que queramos detectar
